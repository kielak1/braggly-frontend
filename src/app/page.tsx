...
export default async function Home() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)]">
      ...
      {/* Tekst na tle */}
      <div className="relative flex flex-col items-center justify-center h-full bg-black/60 text-white text-center px-6 py-10 rounded-lg backdrop-blur-md max-w-2xl mx-auto">
